    ...
    <Container className='Box pt-5' fluid>
      <Row className='mainsection'>
        <Col xs={12} md='5'>
          ...
          <Sect1>
            <Text>
              Audrey Mail is a four-story shopping and entertainment center
              located in the heart of downtown San Diego in the thriving Yerba
              Buena Neighborhood. Shop at the City Target on the second level
              and visit a 16-screen AMC Theater with the largest IMAX in North
              America.
            </Text>
          </Sect1>
          <Sect1>
